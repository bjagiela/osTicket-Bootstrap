...
<div class="container-xxl">
    ...
    <?php } ?>
        <p style="text-align:center">
            <button class="btn btn-sm btn-primary" type="submit"><i class="bi bi-send"></i> <?php echo __('Post Reply');?></button>
            <button class="btn btn-sm btn-dark" type="reset"><i class="bi bi-arrow-counterclockwise"></i> <?php echo __('Reset');?></button>
            <button class="btn btn-sm btn-dark" type="button" onClick="history.go(-1)"><i class="bi bi-x-lg"></i> <?php echo __('Cancel');?></button>
        </p>
    </form>
